...
static rotary_encoder_err_t rotary_encoder_device_initialize(rotary_encoder_t const* encoder)
{
    return encoder->interface.device_initialize
               ? encoder->interface.device_initialize(encoder->interface.device_user)
               : ROTARY_ENCODER_ERR_NULL;
}

static rotary_encoder_err_t rotary_encoder_device_deinitialize(rotary_encoder_t const* encoder)
{
    return encoder->interface.device_deinitialize
               ? encoder->interface.device_deinitialize(encoder->interface.device_user)
               : ROTARY_ENCODER_ERR_NULL;
}
